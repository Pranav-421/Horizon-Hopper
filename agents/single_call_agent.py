...
from agents.commute_agent import get_commute_options
from agents.intent_agent import detect_intent
from agents.itinerary_agent import build_itinerary
from agents.location_agent import get_location_info
from agents.stay_agent import get_stay_options



def run_single_call(source, destination, purpose, budget, travel_time, preferences, memory=None):
    memory = memory or {}
