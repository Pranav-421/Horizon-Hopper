...
from agents.memory_agent import load_user_memory, update_memory
from agents.single_call_agent import run_single_call
...
def run_planner(source, destination, purpose, budget, travel_time, preferences, user_id="guest"):
    user_input = (
